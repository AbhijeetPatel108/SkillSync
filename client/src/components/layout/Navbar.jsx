  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-900/75 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <button className="relative rounded-full border border-white/10 bg-slate-800/80 p-2.5 text-slate-300 transition hover:bg-slate-700 hover:text-white">
            <FiBell size={18} />
          ...
          <div className="flex items-center gap-3 rounded-full border border-white/10 bg-slate-800/80 px-2 py-2 pr-3">
          ...
          <button className="rounded-full border border-white/10 bg-slate-800/80 p-2.5 text-white md:hidden" type="button">
            <FiMenu size={18} />
          </button>
        </div>
      </div>
