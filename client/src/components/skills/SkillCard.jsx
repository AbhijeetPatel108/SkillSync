...
function SkillCard({ user, onSendRequest }) {
  return (
    <div className="rounded-[24px] border border-white/10 bg-slate-900/70 p-6 shadow-[0_20px_70px_-34px_rgba(0,0,0,0.95)] transition duration-300 hover:-translate-y-1 hover:border-violet-400/30">
      ...
      <p className="mt-5 text-sm leading-7 text-slate-300">{user.bio || "No bio available."}</p>

      <div className="mt-5">
        <h3 className="mb-2 text-sm font-semibold uppercase tracking-[0.24em] text-violet-300">Skills Offered</h3>
