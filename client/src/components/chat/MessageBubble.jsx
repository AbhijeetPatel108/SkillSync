function MessageBubble({ message, mine }) {
  return (
    <div className={`mb-4 flex ${mine ? "justify-end" : "justify-start"}`}>
      <div className={`max-w-[80%] rounded-[20px] px-4 py-3 shadow-md sm:max-w-lg ${mine ? "rounded-br-md bg-gradient-to-r from-[#7C3AED] to-[#8b5cf6] text-white" : "rounded-bl-md border border-white/10 bg-slate-800/90 text-slate-100"}`}>
