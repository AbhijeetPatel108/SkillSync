...
function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(124,58,237,0.24),_transparent_35%),linear-gradient(135deg,_#020617_0%,_#0f172a_100%)] px-4 py-10">
      <div className="w-full max-w-lg overflow-hidden rounded-[30px] border border-white/10 bg-slate-900/80 shadow-[0_30px_100px_-20px_rgba(76,29,149,0.9)] backdrop-blur-xl">
